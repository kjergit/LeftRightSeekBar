...
public class CenterSeekBar extends View {
    ...
    public CenterSeekBar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        if (attrs != null) {
            ...
            maxProgress = styledAttrs.getInteger(R.styleable.SeekBarView_SeekBarView_S_maxProgress, 100);
            minProgress = styledAttrs.getInteger(R.styleable.SeekBarView_SeekBarView_S_minProgress, 0);
            width = styledAttrs.getDimension(R.styleable.SeekBarView_SeekBarView_S_width, 800);
            mIsCenterState = styledAttrs.getBoolean(R.styleable.SeekBarView_SeekBarView_S_centerState, false);
            progressBackColor = styledAttrs.getColor(R.styleable.SeekBarView_SeekBarView_S_backColor, Color.BLACK);
            progressBackHeight = styledAttrs.getDimension(R.styleable.SeekBarView_SeekBarView_S_backHeight, 10);
            progressFrameColor = styledAttrs.getColor(R.styleable.SeekBarView_SeekBarView_S_backFrameColor, Color.BLUE);//边框
            progressFrameHeight = styledAttrs.getDimension(R.styleable.SeekBarView_SeekBarView_S_backFrameSize, 3);
            progressColor = styledAttrs.getColor(R.styleable.SeekBarView_SeekBarView_S_progressColor, Color.WHITE);//进度条?
            progressHeight = styledAttrs.getDimension(R.styleable.SeekBarView_SeekBarView_S_progressHeight, progressBackHeight);
            progressMinusColor = styledAttrs.getColor(R.styleable.SeekBarView_SeekBarView_S_progressMinusColor, Color.RED);
            progress = styledAttrs.getInteger(R.styleable.SeekBarView_SeekBarView_S_progress, 0);
            mThumbNormalRadius = styledAttrs.getDimension(R.styleable.SeekBarView_SeekBarView_S_thumbNormalRadius, 14);
            mThumbPressedRadius = styledAttrs.getDimension(R.styleable.SeekBarView_SeekBarView_S_thumbPressRadius, 24);
            mThumbColor = styledAttrs.getColor(R.styleable.SeekBarView_SeekBarView_S_thumbColor, Color.WHITE);
            progressColor = styledAttrs.getColor(R.styleable.SeekBarView_SeekBarView_S_progressColor, Color.WHITE);//进度条
            mTextLocation = styledAttrs.getInteger(R.styleable.SeekBarView_SeekBarView_S_textLocation, 1);
            mTextColor = styledAttrs.getColor(R.styleable.SeekBarView_SeekBarView_S_textColor, Color.WHITE);
            mTextSize = styledAttrs.getDimension(R.styleable.SeekBarView_SeekBarView_S_textSize, 40);
            mTextBackColor = styledAttrs.getColor(R.styleable.SeekBarView_SeekBarView_S_textBackColor, 0x7DD2D3D4);
            mTextBackRadius = styledAttrs.getDimension(R.styleable.SeekBarView_SeekBarView_S_textBackRadius, 10);
     ...
     * 是否可用
     */
    public CenterSeekBar setProgressEnable(boolean enable) {
        if (enable) {
